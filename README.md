...
public class App {
    ...
    public static void main(String[] args) {
        ...
        cuenta.deposit(amountOf(1000), fecha("10/01/2021"));
        cuenta.deposit(amountOf(2000), fecha("13/01/2021"));
        cuenta.withdrawal(amountOf(500), fecha("14/01/2021"));

        cuenta.printStatement(System.out);
    }
